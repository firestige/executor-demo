 ...
 * @since 1.0.0
 * @see RenewalTask
 * @see xyz.firestige.redis.renewal.strategy.ttl.TtlStrategy
 * @see xyz.firestige.redis.renewal.strategy.stop.StopStrategy
 * @see xyz.firestige.redis.renewal.strategy.interval.IntervalStrategy
 * @see xyz.firestige.redis.renewal.listener.LifecycleListener
 * @see xyz.firestige.redis.renewal.selector.KeySelector
 * @see xyz.firestige.redis.renewal.handler.FailureHandler
 */
