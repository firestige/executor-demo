...
public class PatternKeySelector implements KeySelector {
    ...
    @Override public Collection<String> selectKeys(RenewalContext context) { return client.scan(pattern, scanCount); }
    @Override public String getName() { return "PatternKeySelector"; }
}
