...
public class TaskExecutorTest {
    ...
    void testTaskFailureAtSecondStageAndRetrySuccess() {
        ...
        when(stageFactory.buildStages(any())).thenReturn(stages);
        taskDomainService.attacheStages(task, stages);
        ...
        task = taskRecoveryService.recoverForRetry(task.getTaskId(), config, "stage-1");
    ...
    void testRollbackCheckpointBehavior() {
        ...
        String prevVersion = String.valueOf(prevConfig.getDeployUnitVersion() + 1);
        ...
        task = taskRecoveryService.recoverForRollback(task.getTaskId(), prevConfig, "stage-1");
